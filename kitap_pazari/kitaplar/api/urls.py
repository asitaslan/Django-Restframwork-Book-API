...
urlpatterns =[
    ...
    path('kitaplar/<int:pk>', api_views.KitapDetailAPIView.as_view(), name = 'kitap_bilgiler'),
    path('kitaplar/<int:kitap_pk>/yorum_yap', api_views.YorumCreateAPIView.as_view(), name = 'yorum_yap'),
    path('yorumlar/<int:pk>', api_views.YorumDetailAPIView.as_view(), name = 'yorum_bilgiler'),
]